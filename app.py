...
- إذا رفض بشكل واطح: "تمام، أي وقت بدك ترجع بنكون هون 😊"
...
كورس المبتدئين: 25 USD / 18 JOD | https://richarddialatalk.com/
...
الخطوة ٢ — بعد اختيار الطريقة، أرسل تفاصيل الدفع + الشروط الأربعة أدناه + "بعد الدفع بعتلنا سكرينشوت كإثبات، وكمان صورة بروفايل حسابك على الفيسبوك عشان نتفق على الجدول ونختبر مستواك 😊"
