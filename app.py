...
٧. ويسترن يونيون:
   الأردن: رقم زين كاش + "روح أودع عن طٱيق ويسترن يونيون لزين كاش"
...
إذا أخبرك بالدفع (سجلت/دفعت/done وما يشابههة): توقف عن أي معلومات وقل فقط:
...
لا شهاداڪ — لا ضمان جدول قبل التسجيل — لا تبعث IBAN الأردن لدول ممنو�"""
